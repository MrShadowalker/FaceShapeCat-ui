  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="销售" v-bind="validateInfos.saleUserId">
	          <j-search-select v-model:value="formData.saleUserId" dict="sys_user,realname,id,del_flag=0 and username != 'admin'" :disabled="disabled" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="联系地址" v-bind="validateInfos.address" :labelCol="labelCol1" :wrapperCol="wrapperCol1">
	          <a-textarea v-model:value="formData.address" :rows="4" placeholder="请输入联系地址" :disabled="disabled"/>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../EvCustom.api';
  ...
  const validatorRules = {
    ...
    saleUserId: [{ required: true, message: '请输入销售员!'},],
  };
