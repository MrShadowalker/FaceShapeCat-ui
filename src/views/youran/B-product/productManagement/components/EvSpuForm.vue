  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="规格型号" v-bind="validateInfos.spec" :labelCol="labelCol1"
        ...
        <a-col :span="12">
          <a-form-item label="商品状态" v-bind="validateInfos.status">
            <JDictSelectTag v-model:value="formData.status" type="radio" dict-code="ev_goods_status" placeholder="请选择商品状态" :disabled="disabled"></JDictSelectTag>
          </a-form-item>
        </a-col>
        <a-col :span="12" >
          <a-form-item label="零售价" v-bind="validateInfos.price">
            <a-input-number v-model:value="formData.price" :formatter="value => `${value}元`" placeholder="请输入零售价" :disabled="disabled"></a-input-number>
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-divider orientation="left" style="height: 2px;border-color: #999999;"><span style="color: #999999;">进货信息</span></a-divider>
        
        <!-- <a-divider>进货信息</a-divider> -->

        <a-col :span="12">
          <a-form-item label="厂家名称">
            <a-input v-model:value="formData.supplier" placeholder="请输入厂家名称" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="进货价" >
            <a-input-number v-model:value="formData.costPrice" placeholder="请输入进货价" :formatter="value => `${value}元`"  :disabled="disabled"></a-input-number>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="联系地址" :labelCol="labelCol1"
          :wrapperCol="wrapperCol1">
            <a-textarea v-model:value="formData.address" placeholder="请输入联系地址" :disabled="disabled" :rows="4"></a-textarea>
          </a-form-item>
        </a-col>
