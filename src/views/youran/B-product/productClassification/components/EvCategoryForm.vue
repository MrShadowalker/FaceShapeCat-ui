  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="上级节点" v-bind="validateInfos.pid">
            <j-tree-select
              placeholder="请选择上级节点"
        ...
        <a-col :span="12">
          <a-form-item label="分类名称" v-bind="validateInfos.name">
            <a-input v-model:value="formData.name" placeholder="请输入分类名称" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <!-- <a-col :span="12">
          <a-form-item label="商品分类编码" v-bind="validateInfos.code">
            <a-input v-model:value="formData.code" placeholder="请输入商品分类编码" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col> -->
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import {loadTreeData, saveOrUpdateDict} from '../EvCategory.api';
  ...
  const validatorRules = {
    // pid: [{ required: true, message: '请输入上级节点!'},],
  };
