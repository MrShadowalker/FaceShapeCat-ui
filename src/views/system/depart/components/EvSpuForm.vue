<template>
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        <a-col :span="24">
          <a-form-item label="商品图片" v-bind="validateInfos.imgPath" :labelCol="labelCol1" :wrapperCol="wrapperCol1">
            <j-image-upload v-model:value="formData.imgPath" :disabled="disabled"></j-image-upload>
          </a-form-item>
        </a-col>

        <a-col :span="12">
          <a-form-item label="经销商" v-bind="validateInfos.name">
            <a-input v-model:value="formData.name" placeholder="请输入经销商" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="联系人">
            <a-input v-model:value="formData.name" placeholder="请输入联系人" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="联系电话">
            <a-input v-model:value="formData.name" placeholder="请输入联系电话" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="联系地址">
            <a-input v-model:value="formData.name" placeholder="请输入联系地址" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="零售价">
            <a-input v-model:value="formData.name" placeholder="请输入零售价" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="进价">
            <a-input v-model:value="formData.name" placeholder="请输入进价" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        ...
        <a-col :span="12">
         ...
         <a-col :span="12">
          <a-form-item label="商品种类" v-bind="validateInfos.code">
            <a-input v-model:value="formData.code" placeholder="请输入商品种类" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="计量单位" v-bind="validateInfos.code">
            <a-input v-model:value="formData.code" placeholder="请输入计量单位" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="规格型号" v-bind="validateInfos.code">
            <a-input v-model:value="formData.code" placeholder="请输入规格型号" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
...
import {evDisburseAdd, evAdjustAdd} from '../depart.api';
...
function edit(record) {
  nextTick(async () => {
    ...
    if(record.id){
      ...
      const res = await listSpec({spuId:record.id,pageSize:9999})
...
async function nameDuplicatevalidate(_r, value) {
  return duplicateValidate('ev_spu', 'name', value, formData.id || '')
}

async function codeDuplicatevalidate(_r, value) {
  return duplicateValidate('ev_spu', 'code', value, formData.id || '')
}
