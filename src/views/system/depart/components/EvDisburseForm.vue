  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="损耗时间" v-bind="validateInfos.disburseTime">
		        <a-date-picker placeholder="请选择损耗时间"  v-model:value="formData.disburseTime" showTime value-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="损耗类型" v-bind="validateInfos.type">
        ...
        <a-col :span="24">
          <a-form-item label="损耗数量" v-bind="validateInfos.num">
            <a-input v-model:value="formData.num" placeholder="请输入损耗数量" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import {evDisburseAdd} from '../depart.api';
  ...
  async function submitForm() {
    ...
    await evDisburseAdd(model, isUpdate.value)
      .then((res) => {
        if (res.success) {
