...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function (props, context) {
    ...
    var computeResizeleOpts = (0, _vue.computed)(function () {
      return Object.assign({}, _conf.default.table.resizeConfig, props.resizeConfig);
    });
    ...
    computeTooltipOpts = (0, _vue.computed)(function () {
      return Object.assign({}, _conf.default.tooltip, _conf.default.table.tooltipConfig, props.tooltipConfig);
    });
    var computeTipConfig = (0, _vue.computed)(function () {
    ...
    var computeLoadingOpts = (0, _vue.computed)(function () {
      return Object.assign({}, _conf.default.table.loadingConfig, props.loadingConfig);
    });
    ...
    var computeFixedColumnSize = (0, _vue.computed)(function () {
    ...
    var computeIsMaxFixedColumn = (0, _vue.computed)(function () {
      ...
      if (customConfig && (isCustomResizable || isCustomVisible || isCustomFixed || isCustomOrder)) {
        ...
        if (isCustomResizable) {
          ...
          if (columnWidthStorage) {
            _xeUtils.default.each(columnWidthStorage, function (resizeWidth, colKey) {
              customMap_1[colKey] = {
        ...
        _xeUtils.default.each(customMap_1, function (_a, colKey) {
    ...
    var autoCellWidth = function () {
      ...
      pxMinList.forEach(function (column) {
        var minWidth = _xeUtils.default.toInteger(column.minWidth);
        tableWidth += minWidth;
        column.renderWidth = minWidth;
      });
      // 最小百分比
      scaleMinList.forEach(function (column) {
        var scaleWidth = Math.floor(_xeUtils.default.toInteger(column.minWidth) * meanWidth);
        tableWidth += scaleWidth;
        column.renderWidth = scaleWidth;
      });
      // 固定百分比
      scaleList.forEach(function (column) {
        var scaleWidth = Math.floor(_xeUtils.default.toInteger(column.width) * meanWidth);
        tableWidth += scaleWidth;
        column.renderWidth = scaleWidth;
      });
      // 固定宽
      pxList.forEach(function (column) {
        var width = _xeUtils.default.toInteger(column.width);
        tableWidth += width;
        column.renderWidth = width;
      });
      // 调整了列宽
      resizeList.forEach(function (column) {
        var width = _xeUtils.default.toInteger(column.resizeWidth);
        tableWidth += width;
        column.renderWidth = width;
      });
    ...
    var handleVirtualTreeToList = function () {
      ...
      if (treeConfig && treeOpts.transform) {
        ...
        _xeUtils.default.eachTree(internalData.afterTreeFullData, function (row, index, items, path, parent) {
          var rowid = (0, _util.getRowid)($xetable, row);
          var parentRowid = (0, _util.getRowid)($xetable, parent);
    ...
    var updateAfterFullData = function () {
      ...
      if (!allRemoteFilter || !allRemoteSort) {
        ...
        if (sortMultiple && chronological && orderColumns_1.length > 1) {
          orderColumns_1 = _xeUtils.default.orderBy(orderColumns_1, 'sortTime');
        }
        // 处理筛选
        // 支持单列、多列、组合筛选
        ...
        layoutList.forEach(function (layout) {
          ...
          if (layout === 'header') {
            ...
            if ((0, _dom.isNodeElement)(wrapperElem)) {
              var bodyMinHeight = fixedType ? customMinHeight - headerHeight - footerHeight - (showFooter ? 0 : scrollbarHeight) : customMinHeight - headerHeight - footerHeight;
              var bodyMaxHeight = 0;
              if (customMaxHeight) {
              ...
              if (customHeight > 0) {
                var bodyHeight = fixedType ? (customHeight > 0 ? customHeight - headerHeight - footerHeight : tableHeight) - (showFooter ? 0 : scrollbarHeight) : customHeight - headerHeight - footerHeight;
                if (bodyMaxHeight) {
    ...
    var handleAsyncRowExpand = function (row) {
      return new Promise(function (resolve) {
        ...
        if (loadMethod) {
          ...
          var rowid_2 = (0, _util.getRowid)($xetable, row);
    ...
    var computeScrollLoad = function () {
      return (0, _vue.nextTick)().then(function () {
        ...
        if (scrollXLoad) {
          ...
          var offsetXSize = sXOpts.oSize ? _xeUtils.default.toNumber(sXOpts.oSize) : _dom.browse.edge ? 5 : 0;
        ...
        return new Promise(function (resolve) {
          (0, _vue.nextTick)().then(function () {
            ...
            if (oldScrollYLoad === sYLoad) {
              ...
              setTimeout(function () {
                return (0, _util.restoreScrollLocation)($xetable, targetScrollLeft, targetScrollTop).then(resolve);
              });
            }
          });
        });
    ...
    var parseColumns = function () {
      ...
      if (isGroup) {
        ...
        _xeUtils.default.eachTree(collectColumn, function (column, index, items, path, parent) {
          var isColGroup = (0, _utils.hasChildrenList)(column);
    ...
    tableMethods = {
      ...
      loadTreeChildren: function (row, childRecords) {
        ...
        return tableMethods.createData(childRecords).then(function (rows) {
          if (keepSource) {
            var rowid_3 = (0, _util.getRowid)($xetable, row);
            var matchObj = _xeUtils.default.findTree(tableSourceData, function (item) {
              return rowid_3 === (0, _util.getRowid)($xetable, item);
            }, {
              children: childrenField
            });
            if (matchObj) {
      ...
      setColumnFixed: function (fieldOrColumn, fixed) {
        ...
        var targetColumn = (0, _util.getRootColumn)($xetable, column);
          ...
          if (!targetColumn.fixed && isMaxFixedColumn) {
            if (_vXETable.VXETable.modal) {
              _vXETable.VXETable.modal.message({
                status: 'error',
                content: _conf.default.i18n('vxe.table.maxFixedCol')
              });
            }
            return (0, _vue.nextTick)();
          }
      ...
      refreshScroll: function () {
        ...
        return new Promise(function (resolve) {
          ...
          if (lastScrollLeft || lastScrollTop) {
            return (0, _util.restoreScrollLocation)($xetable, lastScrollLeft, lastScrollTop).then().then(function () {
              // 存在滚动行为未结束情况
      ...
      toggleCheckboxRow: function (row) {
        ...
        var checkboxOpts = computeCheckboxOpts.value;
        var checkField = checkboxOpts.checkField;
        var value = checkField ? !_xeUtils.default.get(row, checkField) : !selectCheckboxMaps[(0, _util.getRowid)($xetable, row)];
      ...
      getRadioReserveRecord: function (isFull) {
        ...
        var childrenField = treeOpts.children || treeOpts.childrenField;
        if (radioOpts.reserve && radioReserveRow) {
          var rowid_4 = (0, _util.getRowid)($xetable, radioReserveRow);
          if (isFull) {
            ...
            if (treeConfig) {
              var matchObj = _xeUtils.default.findTree(afterFullData, function (row) {
                return rowid_4 === _xeUtils.default.get(row, rowkey_2);
              }, {
                children: childrenField
              });
              if (matchObj) {
      ...
      getRadioRecord: function (isFull) {
        ...
        if (selectRadioRow) {
          var rowid = (0, _util.getRowid)($xetable, selectRadioRow);
          if (isFull) {
            if (!fullDataRowIdData[rowid]) {
      ...
      getRowExpandRecords: function () {
        var rest = [];
        _xeUtils.default.each(reactData.rowExpandedMaps, function (item) {
          if (item) {
            rest.push(item);
          }
        });
      ...
      getTreeExpandRecords: function () {
        var rest = [];
        _xeUtils.default.each(reactData.treeExpandedMaps, function (item) {
          if (item) {
            rest.push(item);
          }
        });
        ...
        tablePrivateMethods.preventEvent(evnt, 'event.keydown', null, function () {
          ...
          if (operCtxMenu) {
            ...
            if (selected.column && selected.row && (0, _utils.isEnableConf)(selected.column.editRender)) {
              ...
              if (!beforeEditMethod || beforeEditMethod(__assign(__assign({}, selected.args), {
                $table: $xetable
              }))) {
                if (editMethod) {
                  editMethod({
    ...
    var handleTooltip = function (evnt, cell, overflowElem, tipElem, params) {
      ...
      var content = useCustom ? customContent : _xeUtils.default.toString(column.type === 'html' ? overflowElem.innerText : overflowElem.textContent).trim();
    ...
    tablePrivateMethods = {
      ...
      checkSelectionStatus: function () {
        ...
        if (!checkStrictly) {
          ...
          if (checkField) {
            ...
            if (treeConfig) {
              if (indeterminateField) {
                isIndeterminate = !isAllSelected && afterFullData.some(function (row) {
                  return _xeUtils.default.get(row, checkField) || _xeUtils.default.get(row, indeterminateField) || !!treeIndeterminateMaps[(0, _util.getRowid)($xetable, row)];
                });
              } else {
                isIndeterminate = !isAllSelected && afterFullData.some(function (row) {
                  return _xeUtils.default.get(row, checkField) || !!treeIndeterminateMaps[(0, _util.getRowid)($xetable, row)];
                });
              }
            } else {
              if (indeterminateField) {
            ...
            if (treeConfig) {
              isIndeterminate = !isAllSelected && afterFullData.some(function (row) {
                var itemRid = (0, _util.getRowid)($xetable, row);
          ...
          if (treeConfig && !checkStrictly) {
            ...
            if (matchObj && matchObj.parent) {
              ...
              if (!isForce && checkMethod) {
                matchObj.items.forEach(function (item) {
                  if (checkMethod({
                    ...
                    var itemRid = (0, _util.getRowid)($xetable, item);
              ...
              var indeterminatesItem = _xeUtils.default.find(matchObj.items, function (item) {
                return !!treeIndeterminateMaps[(0, _util.getRowid)($xetable, item)];
              });
              if (indeterminatesItem) {
                ...
                parentStatus = selectItems_1.filter(function (item) {
                  return vItemMaps_1[(0, _util.getRowid)($xetable, item)];
            ...
            if (matchObj && matchObj.parent) {
              ...
              if (indeterminatesItem) {
                ...
                parentStatus = selectItems_2.filter(function (item) {
                  return vItemMaps_2[(0, _util.getRowid)($xetable, item)];
      ...
      triggerHeaderHelpEvent: function (evnt, params) {
        ...
        if (titlePrefix.content || titlePrefix.message) {
          var tooltipStore = reactData.tooltipStore;
          var content_1 = (0, _utils.getFuncText)(titlePrefix.content || titlePrefix.message);
      ...
      getCellLabel: function (row, column) {
        ...
        if (formatter) {
          ...
          if (_xeUtils.default.isString(formatter)) {
            var gFormatOpts = _vXETable.VXETable.formats.get(formatter);
            ...
            var gFormatOpts = _vXETable.VXETable.formats.get(formatter[0]);
    ...
    var renderEmptyContenet = function () {
      ...
      if (slots.empty) {
        ...
        if (renderEmpty) {
          return (0, _vn.getSlotVNs)(renderEmpty(emptyOpts, params));
        }
      }
      ...
      loadTableData(props.data || []).then(function () {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          if (checkboxColumn && internalData.tableFullData.length > 300 && !checkboxOpts.checkField) {
            (0, _log.warnLog)('vxe.error.checkProp', ['checkbox-config.checkField']);
          }
    ...
    var staticColumnFlag = (0, _vue.ref)(0);
    (0, _vue.watch)(function () {
    ...
    (0, _vue.watch)(staticColumnFlag, function () {
      handleColumn(reactData.staticColumns);
    });
    var tableColumnFlag = (0, _vue.ref)(0);
    (0, _vue.watch)(function () {
    ...
    (0, _vue.watch)(tableColumnFlag, function () {
      tablePrivateMethods.analyColumnWidth();
    });
    (0, _vue.watch)(function () {
    ...
    var mergeCellFlag = (0, _vue.ref)(0);
    (0, _vue.watch)(function () {
    ...
    (0, _vue.watch)(mergeCellFlag, function () {
      tableMethods.clearMergeCells();
      (0, _vue.nextTick)(function () {
        if (props.mergeCells) {
    ...
    var mergeFooterItemFlag = (0, _vue.ref)(0);
    (0, _vue.watch)(function () {
    ...
    (0, _vue.watch)(mergeFooterItemFlag, function () {
      tableMethods.clearMergeFooterItems();
      (0, _vue.nextTick)(function () {
    ...
    (0, _vue.onMounted)(function () {
      (0, _vue.nextTick)(function () {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          if (importConfig && importOpts.types && !importOpts.importMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.globalConfs.importTypes, importOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', ["export-config.types=".concat(importOpts.types.join(',')), importOpts.types.filter(function (type) {
              return _xeUtils.default.includes(_vXETable.VXETable.globalConfs.importTypes, type);
            }).join(',') || _vXETable.VXETable.globalConfs.importTypes.join(',')]);
          }
          if (exportConfig && exportOpts.types && !exportOpts.exportMethod && !_xeUtils.default.includeArrays(_vXETable.VXETable.globalConfs.exportTypes, exportOpts.types)) {
            (0, _log.warnLog)('vxe.error.errProp', ["export-config.types=".concat(exportOpts.types.join(',')), exportOpts.types.filter(function (type) {
              return _xeUtils.default.includes(_vXETable.VXETable.globalConfs.exportTypes, type);
            }).join(',') || _vXETable.VXETable.globalConfs.exportTypes.join(',')]);
          }
        }
        if (process.env.NODE_ENV === 'development') {
          var customOpts = computeCustomOpts.value;
        ...
        if (props.autoResize) {
          ...
          var handleOptimizeResize_1 = refreshDelay ? _xeUtils.default.throttle(function () {
            return tableMethods.recalculate(true);
          }, refreshDelay, {
            leading: true,
            trailing: true
          }) : null;
          resizeObserver = (0, _resize.createResizeEvent)(handleOptimizeResize_1 ? function () {
            if (props.autoResize) {
    ...
    var renderVN = function () {
      ...
      return (0, _vue.h)('div', {
        ref: refElem,
        class: ['vxe-table', 'vxe-table--render-default', "tid_".concat(xID), "border--".concat(tableBorder), (_a = {}, _a["size--".concat(vSize)] = vSize, _a["vaild-msg--".concat(validOpts.msgMode)] = !!editRules, _a['vxe-editable'] = !!editConfig, _a['old-cell-valid'] = editRules && _conf.default.cellVaildMode === 'obsolete', _a['cell--highlight'] = highlightCell, _a['cell--selected'] = mouseConfig && mouseOpts.selected, _a['cell--area'] = mouseConfig && mouseOpts.area, _a['row--highlight'] = rowOpts.isHover || highlightHoverRow, _a['column--highlight'] = columnOpts.isHover || highlightHoverColumn, _a['is--header'] = showHeader, _a['is--footer'] = showFooter, _a['is--group'] = isGroup, _a['is--tree-line'] = treeConfig && (treeOpts.showLine || treeOpts.line), _a['is--fixed-left'] = leftList.length, _a['is--fixed-right'] = rightList.length, _a['is--animat'] = !!props.animat, _a['is--round'] = props.round, _a['is--stripe'] = !treeConfig && stripe, _a['is--loading'] = loading, _a['is--empty'] = !loading && !tableData.length, _a['is--scroll-y'] = overflowY, _a['is--scroll-x'] = overflowX, _a['is--virtual-x'] = scrollXLoad, _a['is--virtual-y'] = scrollYLoad, _a)],
      ...
      hasUseTooltip ? (0, _vue.h)((0, _vue.resolveComponent)('vxe-tooltip'), __assign({
        ref: refTooltip
      }, tipConfig)) : (0, _vue.createCommentVNode)()]);
    };
