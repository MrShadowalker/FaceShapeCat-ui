  ...
  setupTable: function ($xetable) {
    ...
    validatorPrivateMethods = {
      ...
      showValidTooltip: function (params) {
        ...
        if (validOpts.msgMode === 'single') {
          reactData.validErrorMaps = (_a = {}, _a["".concat((0, _util.getRowid)($xetable, params.row), ":").concat(params.column.id)] = {
          ...
          reactData.validErrorMaps = Object.assign({}, validErrorMaps, (_b = {}, _b["".concat((0, _util.getRowid)($xetable, params.row), ":").concat(params.column.id)] = {
            column: params.column,
            row: params.row,
            rule: params.rule,
            content: params.rule.content
