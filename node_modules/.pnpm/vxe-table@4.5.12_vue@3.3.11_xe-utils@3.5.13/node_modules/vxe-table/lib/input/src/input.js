...
var _default = (0, _vue.defineComponent)({
  ...
  props: {
    ...
    placeholder: {
      type: String,
      default: function () {
        return _xeUtils.default.eqNull(_conf.default.input.placeholder) ? _conf.default.i18n('vxe.base.pleaseInput') : _conf.default.input.placeholder;
      }
    },
  ...
  setup: function (props, context) {
    ...
    var computeDateStartTime = (0, _vue.computed)(function () {
      return props.startDate ? _xeUtils.default.toStringDate(props.startDate) : null;
    });
    var computeDateEndTime = (0, _vue.computed)(function () {
      return props.endDate ? _xeUtils.default.toStringDate(props.endDate) : null;
    });
    var computeSupportMultiples = (0, _vue.computed)(function () {
      return ['date', 'week', 'month', 'quarter', 'year'].includes(props.type);
    });
    var computeDateListValue = (0, _vue.computed)(function () {
    ...
    var computeDateMultipleValue = (0, _vue.computed)(function () {
    ...
    var computeDateMultipleLabel = (0, _vue.computed)(function () {
      var dateListValue = computeDateListValue.value;
    ...
    var computeDateLabelFormat = (0, _vue.computed)(function () {
      var isDatePickerType = computeIsDatePickerType.value;
      if (isDatePickerType) {
        return props.labelFormat || _conf.default.i18n("vxe.input.date.labelFormat.".concat(props.type));
      }
      return null;
    });
    ...
    var computeNumValue = (0, _vue.computed)(function () {
      var type = props.type;
    ...
    var computeIsDisabledSubtractNumber = (0, _vue.computed)(function () {
      var min = props.min;
      var inputValue = reactData.inputValue;
      var isNumType = computeIsNumType.value;
    ...
    var computeIsDisabledAddNumber = (0, _vue.computed)(function () {
      var max = props.max;
      var inputValue = reactData.inputValue;
      var isNumType = computeIsNumType.value;
      var numValue = computeNumValue.value;
        ...
        if (multiple) {
          ...
          if (isDateTimeType) {
            ...
            emitModel(datetimeRest_2.map(function (date) {
              return _xeUtils.default.toDateString(date, dateValueFormat_1);
            }).join(','), {
              type: 'update'
            });
          } else {
    ...
    var renderDateMonthTable = function () {
      ...
      return [(0, _vue.h)('table', {
        ...
        return (0, _vue.h)('tr', rows.map(function (item) {
          ...
          }, renderDateLabel(item, _conf.default.i18n("vxe.input.date.months.m".concat(item.month))));
        }));
      }))])];
    };
    var renderDateQuarterTable = function () {
      ...
      return [(0, _vue.h)('table', {
        ...
        return (0, _vue.h)('tr', rows.map(function (item) {
          ...
          }, renderDateLabel(item, _conf.default.i18n("vxe.input.date.quarters.q".concat(item.quarter))));
        }));
      }))])];
    };
